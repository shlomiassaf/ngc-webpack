// taken from
// https://github.com/angular/material2/blob/master/tools/package-tools/rollup-globals.ts
// https://github.com/dherges/ng-packagr/blob/master/src/lib/conf/rollup.globals.ts

export const predefinedExternals = {
  '@angular': {
  ...
  '@angular/material': {
    ...
    '@angular/material/paginator': 'ng.materialPaginator',
